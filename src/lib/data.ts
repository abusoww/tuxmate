...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    unavailableReason:
      "Archived project; removed from Fedora. CLI-only (no Flatpak/Snap).",
  },
  {
    id: "eza",
    name: "eza",
    ...
    unavailableReason:
      "Unmaintained on Fedora; removed from repos. CLI-only (no Flatpak/Snap).",
  },
  {
    id: "bat",
    name: "bat",
  ...
  },
  {
    ...
    unavailableReason:
      "`https://nodesource.com/products/distributions` Install Node.js to get npm.",
  },
  {
    id: "pnpm",
    name: "pnpm",
    ...
    unavailableReason:
      "Install via `curl -fsSL https://get.pnpm.io/install.sh | sh`.",
  },
  {
    id: "yarn",
    name: "yarn",
    ...
    unavailableReason: "Install via `npm install --global yarn`.",
  },
  ...
  },
  {
    ...
    targets: { arch: "davinci-resolve", nix: "davinci-resolve" },
    unavailableReason:
      "Not in most official repos. Use [AUR](https://aur.archlinux.org/packages/davinci-resolve) or download from [blackmagicdesign.com](https://www.blackmagicdesign.com/products/davinciresolve).",
  },
  ...
  },
  {
    ...
    unavailableReason:
      "Not in official Ubuntu/Debian repos. Use [Flatpak](https://flathub.org/apps/org.zotero.Zotero)/[Snap](https://snapcraft.io/zotero-snap) or download from [zotero.org](https://www.zotero.org/download/).",
  },
  {
    id: "trilium",
    name: "Trilium Notes",
    ...
    unavailableReason:
      "Not in official repos. Use [Flatpak](https://flathub.org/apps/com.github.zadam.trilium) or download from [github.com/zadam/trilium](https://github.com/zadam/trilium/releases).",
  },
  ...
  },
  {
    ...
    targets: { arch: "freedownloadmanager-bin" },
    unavailableReason:
      "Not in official repos. See [freedownloadmanager.org](https://www.freedownloadmanager.org/) for other methods.",
  },
  ...
  },
  {
    ...
    description:
      "Utility for management of disk devices, partitions and file systems",
    category: "System",
    iconUrl: si("kde", "#1D99F3"),
    targets: {
